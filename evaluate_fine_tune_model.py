...
def main(config_file, eval_type):
    ...
    print_completion(config['base_model'] + "case", get_completion_text(base_completion))
    ...
    if compare_model:
        ...
        print_completion(compare_model + " case", get_completion_text(compare_completion))

    compare_model2 = config.get('compare_model2')
    if compare_model2:
        compare_completion2 = get_completion(client, compare_model2, messages)
        print_completion(compare_model2 + " case", get_completion_text(compare_completion2))
    ...
    if compare_model3 and eval_type != 'a':
        ...
        print_completion(compare_model3 + " case", get_completion_text(compare_completion3))
